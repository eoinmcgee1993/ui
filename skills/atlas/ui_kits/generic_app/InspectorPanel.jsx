  ...
  return (
    <aside style={{width:280, background:'#000', borderLeft:'1px solid #1e1e1e', display:'flex', flexDirection:'column', flexShrink:0}}>
      <div className="atlas-panel-header">
        <span className="atlas-panel-title">Inspector</span>
        <div style={{display:'flex', gap:2}}>
          <button className="atlas-btn atlas-btn-icon" style={{width:22, height:22}}>
      ...
      <div style={{padding:'12px 14px 16px', overflowY:'auto', flex:1}}>
        ...
        <div style={{display:'flex', alignItems:'center', gap:8, marginBottom:12}}>
          <span className="atlas-dot atlas-dot-success"></span>
        ...
        <div className="atlas-card" style={{marginBottom:12}}>
          ...
          <div className="atlas-card-body" style={{padding:'8px 12px 10px'}}>
            {[
              ['Owner', 'M. Kerr'],
              ['Status', 'Active'],
              ['Region', 'us-east-1'],
        ...
        <div className="atlas-card" style={{marginBottom:12}}>
          ...
          <div className="atlas-card-body" style={{padding:'10px 12px 12px'}}>
            <div className="atlas-progress" style={{marginBottom:8}}><div className="atlas-progress-bar" style={{width:'88%'}}/></div>
        ...
        <div style={{marginBottom:12}}>
          ...
          <div style={{display:'flex', flexWrap:'wrap', gap:4}}>
            <span className="atlas-pill">infrastructure</span>
            <span className="atlas-pill">q2</span>
            <span className="atlas-pill">engineering</span>
            <span className="atlas-pill atlas-pill-active">+ Add</span>
          </div>
        </div>

        {/* Actions */}
        <div style={{display:'flex', gap:6}}>
          <button className="atlas-btn atlas-btn-primary" style={{flex:1}}>Open</button>
          <button className="atlas-btn atlas-btn-secondary">Share</button>
          <button className="atlas-btn atlas-btn-icon">
