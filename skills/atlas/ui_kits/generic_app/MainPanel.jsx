  ...
  return (
    <section style={{flex:1, display:'flex', flexDirection:'column', minWidth:0, background:'#000'}}>
      <div className="atlas-tabbar">
        <button className="atlas-tab is-active">
          ...
          Projects
          <span className="atlas-badge" style={{marginLeft:4}}>7</span>
        </button>
        ...
        <div style={{flex:1}}/>
        <button className="atlas-btn atlas-btn-ghost atlas-btn-sm" style={{margin:'auto 4px'}}>
      ...
      <div style={{height:40, padding:'0 16px', display:'flex', alignItems:'center', gap:8, borderBottom:'1px solid #141414', flexShrink:0}}>
        <input className="atlas-input atlas-input-sm" placeholder="Filter projects…" style={{width:240, height:22}}/>
        <span className="atlas-pill atlas-pill-active">Owner: any</span>
        <span className="atlas-pill">Status: any</span>
        <span className="atlas-pill">Updated: 7d</span>
        <div style={{flex:1}}/>
        <span className="mono" style={{fontSize:11, color:'#585858'}}>7 of 7</span>
        <div className="atlas-divider-v" style={{height:16}}/>
          ...
          return (
            <div key={r.id} style={{display:'grid', gridTemplateColumns:'86px 1fr 140px 120px 120px 60px', padding:'7px 16px', fontSize:12, alignItems:'center', borderBottom:'1px solid #141414', color:'#aaa', cursor:'pointer', background: i===2 ? 'rgba(255,255,255,0.04)' : 'transparent'}}>
              ...
              <span style={{display:'flex', alignItems:'center', gap:6}}>
                <span className={'atlas-dot atlas-dot-'+st.dot}></span>
                {st.label}
              </span>
              <span style={{display:'flex', alignItems:'center', gap:8}}>
                <div className="atlas-progress" style={{flex:1, height:3}}>
                  <div className="atlas-progress-bar" style={{width: r.progress+'%'}}/>
                </div>
