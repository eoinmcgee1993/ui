...
export default function SliderPage() {
  return (
    ...
    >
      <PageHeader
        eyebrow=".atlas-slider"
        title="Slider"
        meta={[".atlas-slider", ".atlas-slider-track", ".atlas-slider-range", ".atlas-slider-thumb"]}
        subtitle="Horizontal range slider. Blue fill, square thumb, compact track."
      />
