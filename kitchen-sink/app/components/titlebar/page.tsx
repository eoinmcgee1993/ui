...
export default function TitlebarPage() {
  return (
    ...
    >
      <PageHeader
        eyebrow=".atlas-titlebar"
        title="Titlebar"
        meta={[".atlas-titlebar"]}
        subtitle="36px app header. Brand on the left, status in the center, actions on the right."
      />
      <Section title="Default">
        <Example
          block
          html={`<header class="atlas-titlebar" style="border:1px solid var(--border-default);border-radius:6px">
