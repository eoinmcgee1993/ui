...
export default function IconsPage() {
  return (
    <PageBody
      inspector={
        <Inspector
          anatomy="Lucide, 1.5px stroke, color inherited. 16px default, 18px titlebar, 11px card header."
          dos={["Use Lucide (npm: lucide-react, or CDN)", "Stroke 1.5px, color inherited from text"]}
          donts={["No emoji anywhere", "No unicode symbols like ★ → ✓", "Don't animate icons"]}
        />
      }
    >
      <PageHeader
        eyebrow="Foundations"
        title="Icons"
        subtitle="Lucide everywhere. 1.5px stroke. Color inherits from the parent. Never emoji, never unicode symbols — always a real glyph."
      />
      <Section title="Sizing" desc="Context-specific sizing keeps visual rhythm tight.">
