...
const PRODUCTS = [
  ...
  { id: "p6", name: "Atlas Side Table", tag: "Surfaces", price: 310, tone: "#2a2a3a", badge: "NEW" },
...
function ProductTile({ p }: { p: (typeof PRODUCTS)[number] }) {
  return (
    <div style={{ border: "1px solid var(--border-default)", borderRadius: 8, overflow: "hidden", background: "var(--bg-raised)", display: "flex", flexDirection: "column" }}>
      ...
      >
        {p.badge && <span style={{ position: "absolute", top: 10, left: 10 }} className="atlas-badge atlas-badge-info">{p.badge}</span>}
        {p.pct && <span style={{ position: "absolute", top: 10, left: 10 }} className="atlas-badge atlas-badge-warning">-{p.pct}%</span>}
        <button className="atlas-btn atlas-btn-icon" style={{ position: "absolute", top: 10, right: 10, background: "rgba(10,10,10,0.6)", border: "1px solid rgba(255,255,255,0.08)" }} aria-label="Favorite">
      ...
      <div style={{ padding: 14 }}>
        ...
        <div style={{ display: "flex", gap: 6 }}>
          <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm" style={{ flex: 1 }}>Add to cart</button>
          <button className="atlas-btn-pill atlas-btn-pill-secondary atlas-btn-pill-sm">View</button>
        </div>
      </div>
    </div>
  );
    ...
    <div style={{ background: "var(--bg-base)", color: "var(--text-primary)", fontFamily: "var(--font-ui)", minHeight: "calc(100vh - 52px)" }}>
      ...
      <header style={{ display: "flex", alignItems: "center", gap: 24, padding: "14px 32px", borderBottom: "1px solid var(--border-default)", position: "sticky", top: 0, background: "var(--bg-base)", zIndex: 10 }}>
        ...
        <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
          <div style={{ width: "min(440px, 60%)", position: "relative" }}>
            <input className="atlas-input" placeholder="Search products…" style={{ width: "100%", paddingLeft: 30 }} />
        ...
        <button className="atlas-btn atlas-btn-icon" aria-label="Account"><Icon paths="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2|circle:12,7,4" /></button>
        <button className="atlas-btn atlas-btn-icon" aria-label="Favorites"><Icon paths="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z" /></button>
        <button onClick={() => setCartOpen(!cartOpen)} className="atlas-btn-pill atlas-btn-pill-secondary atlas-btn-pill-sm" style={{ gap: 6 }}>
      ...
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr", padding: "32px 32px 24px", gap: 24, alignItems: "stretch" }}>
        <div style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
          <p className="atlas-eyebrow" style={{ marginBottom: 14 }}>Winter collection · '26</p>
          <h1 className="atlas-display" style={{ fontSize: 48, letterSpacing: "-0.03em", margin: "0 0 14px", maxWidth: 14 + "ch" }}>
            Objects that age well.
          </h1>
          <p style={{ fontSize: 15, color: "var(--text-secondary)", lineHeight: 1.55, maxWidth: 540, margin: "0 0 20px" }}>
            Eight new pieces built from solid oak, anodized aluminum, and woven wool.
            Designed to read quiet, feel warm, and outlast the room they sit in.
          </p>
          <div style={{ display: "flex", gap: 8 }}>
            <button className="atlas-btn-pill atlas-btn-pill-primary">Shop the collection</button>
            <button className="atlas-btn-pill atlas-btn-pill-ghost">Lookbook →</button>
          </div>
      ...
      <div style={{ borderTop: "1px solid var(--border-default)", display: "grid", gridTemplateColumns: "240px 1fr", padding: "0 32px 48px" }}>
        ...
        <aside style={{ position: "sticky", top: 80, alignSelf: "start", display: "flex", flexDirection: "column", gap: 18, borderRight: "1px solid var(--border-default)", padding: "24px 24px 24px 0", marginRight: 24 }}>
          <div>
            <div className="atlas-eyebrow" style={{ marginBottom: 8 }}>Category</div>
          ...
          <div>
            <div className="atlas-eyebrow" style={{ marginBottom: 8 }}>Price</div>
            <div style={{ padding: "10px 6px" }}>
              <div style={{ display: "flex", gap: 6, marginBottom: 10 }}>
                <input className="atlas-input atlas-input-sm" placeholder="Min" defaultValue="$100" style={{ flex: 1, fontFamily: "var(--font-mono)", fontSize: 11 }} />
                <input className="atlas-input atlas-input-sm" placeholder="Max" defaultValue="$2,000" style={{ flex: 1, fontFamily: "var(--font-mono)", fontSize: 11 }} />
              </div>
          ...
          <div>
            <div className="atlas-eyebrow" style={{ marginBottom: 8 }}>Material</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
              {["Oak", "Aluminum", "Linen", "Brass", "Wool", "Glass"].map((m, i) => (
                <span key={m} className={`atlas-pill${i < 2 ? " atlas-pill-active" : ""}`}>{m}</span>
              ))}
            </div>
          </div>
          <div>
            <div className="atlas-eyebrow" style={{ marginBottom: 8 }}>In stock</div>
            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13 }}>
              <input type="checkbox" className="atlas-checkbox" defaultChecked /> Ready to ship
            </label>
            <label style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 13, marginTop: 6 }}>
              <input type="checkbox" className="atlas-checkbox" /> Made to order
            </label>
          </div>
          <button className="atlas-btn atlas-btn-ghost" style={{ justifyContent: "flex-start" }}>Clear filters</button>
        </aside>
        ...
        <div style={{ paddingTop: 24 }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 0 14px", borderBottom: "1px solid var(--border-default)", marginBottom: 18 }}>
            ...
            <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
              ...
              <div className="atlas-segmented">
                <button className="atlas-segmented-item is-active">Newest</button>
                <button className="atlas-segmented-item">Price</button>
                <button className="atlas-segmented-item">Popular</button>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginTop: 32 }}>
            <nav className="atlas-pagination">
              ...
              <button className="atlas-pagination-item">4</button>
              <span className="atlas-pagination-ellipsis">…</span>
              <button className="atlas-pagination-item">8</button>
              <button className="atlas-pagination-item">›</button>
            </nav>
          </div>
        </div>
        ...
        <div onClick={() => setCartOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 40 }}>
          <aside onClick={(e) => e.stopPropagation()} style={{ position: "fixed", top: 0, right: 0, bottom: 0, width: 380, background: "var(--bg-base)", borderLeft: "1px solid var(--border-default)", display: "flex", flexDirection: "column", zIndex: 50 }}>
            <div style={{ padding: "16px 20px", borderBottom: "1px solid var(--border-default)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              ...
              <button className="atlas-btn atlas-btn-icon" onClick={() => setCartOpen(false)} aria-label="Close"><Icon paths="M18 6 6 18M6 6l12 12" /></button>
            </div>
            <div style={{ flex: 1, overflowY: "auto", padding: 16, display: "flex", flexDirection: "column", gap: 12 }}>
              {PRODUCTS.slice(0, 3).map((p) => (
                <div key={p.id} style={{ display: "flex", gap: 10, padding: 10, border: "1px solid var(--border-default)", borderRadius: 6 }}>
                  <div className="atlas-filmstrip" style={{ width: 54, height: 54, borderRadius: 4, background: `linear-gradient(135deg, ${p.tone} 0%, #0a0a0a 100%)`, flex: "none" }} />
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: 6 }}>
                      <div className="atlas-segmented" style={{ height: 22 }}>
                        <button className="atlas-segmented-item" style={{ padding: "0 6px" }}>−</button>
                        <button className="atlas-segmented-item is-active" style={{ padding: "0 8px" }}>1</button>
                        <button className="atlas-segmented-item" style={{ padding: "0 6px" }}>+</button>
                      </div>
            ...
            <div style={{ padding: 16, borderTop: "1px solid var(--border-default)", display: "flex", flexDirection: "column", gap: 10 }}>
              ...
              <button className="atlas-btn-pill atlas-btn-pill-primary">Checkout →</button>
            </div>
          </aside>
        </div>
      )}
