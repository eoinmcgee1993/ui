...
const STATUS_MAP: Record<string, { color: string; dot: string; pulse?: boolean }> = {
  running: { color: "var(--status-info)", dot: "atlas-dot-info", pulse: true },
  idle: { color: "var(--text-tertiary)", dot: "atlas-dot-primary" },
  done: { color: "var(--status-success)", dot: "atlas-dot-success" },
  queued: { color: "var(--status-warning)", dot: "atlas-dot-warning" },
};
    ...
    <div style={{ display: "grid", gridTemplateColumns: "240px 1fr 320px", height: "calc(100vh - 52px)", background: "var(--bg-base)", color: "var(--text-primary)", fontFamily: "var(--font-ui)" }}>
      ...
      <aside style={{ borderRight: "1px solid var(--border-default)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ height: 56, boxSizing: "border-box", padding: "0 12px", display: "flex", alignItems: "center", borderBottom: "1px solid var(--border-default)" }}>
          <button className="atlas-btn atlas-btn-primary" style={{ width: "100%" }}>
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                  ...
                  <span className={`atlas-dot ${s.dot}${s.pulse ? " is-pulse" : ""}`} style={{ marginLeft: "auto" }} />
                </div>
      ...
      <main style={{ display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ height: 56, boxSizing: "border-box", padding: "0 24px", borderBottom: "1px solid var(--border-default)", display: "flex", alignItems: "center", gap: 12 }}>
          <div>
            ...
            <div style={{ fontSize: 11, color: "var(--text-tertiary)", marginTop: 2 }}>4 agents · 12 tool calls · running 2m 14s</div>
          </div>
          <div style={{ flex: 1 }} />
          <span className="atlas-badge atlas-badge-info">LIVE</span>
          <button className="atlas-btn atlas-btn-secondary">Share</button>
          <button className="atlas-btn atlas-btn-icon" aria-label="More"><Icon paths="circle:12,12,1|circle:19,12,1|circle:5,12,1" /></button>
        </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: "24px 32px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-end", marginBottom: 20 }}>
            <div style={{ maxWidth: "72%", padding: "10px 14px", background: "var(--bg-raised)", border: "1px solid var(--border-default)", borderRadius: 10, fontSize: 13, lineHeight: 1.55 }}>
              Our AWS bill jumped 34% this week in us-east-1. Break it down, figure out what caused it, and draft a remediation plan.
            </div>
          </div>

          {/* Researcher turn */}
          <AgentTurn name="Researcher" model="claude-opus-4.7" time="12:42:08" color="var(--status-info)" icon="circle:11,11,8|M21 21l-4.3-4.3">
            <p style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text-secondary)", margin: "0 0 12px" }}>Pulling cost explorer data now. Let me fetch the weekly breakdown.</p>
            ...
            <div className="atlas-card" style={{ marginTop: 12 }}>
              <div className="atlas-card-header">
                <span className="atlas-dot atlas-dot-warning" />
                <span className="atlas-panel-title">EC2 spend · us-east-1 · 7d</span>
              </div>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text-secondary)", margin: "12px 0" }}>
              The spike started Friday. 82% of the increase comes from <code style={{ fontFamily: "var(--font-mono)", fontSize: 11, background: "var(--bg-input)", padding: "1px 5px", borderRadius: 3, border: "1px solid var(--border-default)", color: "var(--text-primary)" }}>c6g.8xlarge</code> instances. Handing off to Coder to scan recent infra PRs.
            </p>
          </AgentTurn>
          ...
          <AgentTurn name="Coder" model="claude-opus-4.7" time="12:43:24" color="var(--status-info)" icon="polyline:16 18 22 12 16 6|polyline:8 6 2 12 8 18">
            ...
            <div className="atlas-card" style={{ marginTop: 12 }}>
              <div className="atlas-card-header" style={{ display: "flex", justifyContent: "space-between" }}>
                <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span className="atlas-dot atlas-dot-error" />
                  <span className="atlas-panel-title" style={{ fontFamily: "var(--font-mono)", fontSize: 11 }}>terraform/ec2/workers.tf</span>
                </span>
                <span style={{ fontSize: 10, color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>PR #842 · 3d ago</span>
              </div>
              <div className="atlas-card-body ks-live-card-body-flush" style={{ padding: 0 }}>
            ...
            <p style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text-secondary)", margin: "12px 0" }}>
              Found it. PR #842 raised <code style={{ fontFamily: "var(--font-mono)", fontSize: 11, background: "var(--bg-input)", padding: "1px 5px", borderRadius: 3, border: "1px solid var(--border-default)", color: "var(--text-primary)" }}>min_size</code> from 2 to 12 as part of a load-test setup that was never reverted. We're over-provisioned by ~10× during off-peak.
            </p>
          </AgentTurn>
          ...
          <AgentTurn name="Writer" model="claude-sonnet-4.6" time="12:44:51" color="var(--status-success)" icon="M12 20h9|M16.5 3.5a2.121 2.121 0 1 1 3 3L7 19l-4 1 1-4L16.5 3.5z">
            <p style={{ fontSize: 13, lineHeight: 1.6, color: "var(--text-secondary)", margin: "0 0 12px" }}>
              Here's the remediation plan. Three-step rollout to avoid impacting the scheduled Friday load test.
            </p>

            <div className="atlas-card">
              <div className="atlas-card-header">
                <span className="atlas-panel-title">Remediation plan</span>
              </div>
              <div className="atlas-card-body" style={{ padding: 12 }}>
                <ol className="atlas-stepper" style={{ listStyle: "none", padding: 0, margin: "0 0 12px", display: "flex", alignItems: "center", gap: 6, fontSize: 11 }}>
                  <li className="atlas-stepper-step is-active" style={{ display: "flex", alignItems: "center", gap: 6 }}><span className="atlas-stepper-dot" /><span className="atlas-stepper-label">Revert</span></li>
                  <li className="atlas-stepper-sep" style={{ flex: 1, height: 1, background: "var(--border-default)" }} />
                  <li className="atlas-stepper-step" style={{ display: "flex", alignItems: "center", gap: 6 }}><span className="atlas-stepper-dot" /><span className="atlas-stepper-label">Guardrail</span></li>
                  <li className="atlas-stepper-sep" style={{ flex: 1, height: 1, background: "var(--border-default)" }} />
                  <li className="atlas-stepper-step" style={{ display: "flex", alignItems: "center", gap: 6 }}><span className="atlas-stepper-dot" /><span className="atlas-stepper-label">Alert</span></li>
                </ol>
                <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: 12 }}>
                  {[
                    ...
                    <label key={t.label} style={{ display: "flex", alignItems: "center", gap: 10, padding: "6px 0" }}>
                      <input type="checkbox" className="atlas-checkbox" />
                ...
                <div style={{ display: "flex", gap: 6, marginTop: 12 }}>
                  <button className="atlas-btn atlas-btn-primary">Open revert PR</button>
                  <button className="atlas-btn atlas-btn-secondary">Assign to Reviewer</button>
                </div>
              </div>
            </div>
          </AgentTurn>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "12px 0", color: "var(--text-tertiary)", fontSize: 12 }}>
            ...
            <span>Reviewer agent is preparing its review…</span>
        ...
        <div style={{ height: 72, boxSizing: "border-box", padding: 14, borderTop: "1px solid var(--border-default)", background: "var(--bg-raised)", flex: "none", display: "flex", alignItems: "center" }}>
          <div style={{ display: "flex", gap: 6, alignItems: "center", padding: "6px 8px", background: "var(--bg-input)", border: "1px solid var(--border-default)", borderRadius: 8, width: "100%" }}>
            ...
            <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm">Send</button>
          </div>
        </div>
      </main>
      ...
      <aside style={{ borderLeft: "1px solid var(--border-default)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
        <div style={{ height: 56, boxSizing: "border-box", borderBottom: "1px solid var(--border-default)", padding: "0 14px", display: "flex", alignItems: "center", gap: 6 }}>
          <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm">Tool I/O</button>
          <button className="atlas-btn-pill atlas-btn-pill-ghost atlas-btn-pill-sm">Artifacts</button>
          <button className="atlas-btn-pill atlas-btn-pill-ghost atlas-btn-pill-sm">Citations</button>
        </div>
        <div style={{ flex: 1, overflowY: "auto", padding: 14 }}>
          ...
          {[
            ...
            <div key={t.time} style={{ padding: "8px 0", borderBottom: "1px solid var(--border-subtle)", display: "flex", alignItems: "center", gap: 8 }}>
              <span className={`atlas-dot atlas-dot-${t.ok ? "success" : "error"}`} />
...
function ToolCall({ name, args, duration }: { name: string; args: string; duration: string }) {
  return (
    <div className="atlas-card" style={{ marginBottom: 10 }}>
      <div className="atlas-card-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
      ...
      <div className="atlas-card-body" style={{ padding: 10, fontFamily: "var(--font-mono)", fontSize: 11, background: "var(--bg-input)", color: "var(--text-secondary)", borderTop: "1px solid var(--border-subtle)" }}>
        {args}
      </div>
    </div>
  );
