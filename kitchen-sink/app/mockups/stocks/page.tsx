    ...
    >
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <span
            className="atlas-dot atlas-dot-success is-pulse"
            style={{ flex: "none" }}
          />
          <div style={{ fontSize: 14, fontWeight: 600 }}>Atlas Markets</div>
          <span style={{ fontSize: 11, color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>
            · Tuesday, Nov 19
          </span>
        </div>

        <div className="atlas-segmented" style={{ marginLeft: 8 }}>
          <button className="atlas-segmented-item is-active">US</button>
          <button className="atlas-segmented-item">EU</button>
          <button className="atlas-segmented-item">ASIA</button>
          <button className="atlas-segmented-item">Crypto</button>
        </div>
        ...
        <span className="atlas-badge atlas-badge-info" style={{ marginLeft: 6 }}>LIVE</span>
        <button className="atlas-btn atlas-btn-icon" aria-label="Refresh">
      ...
      >
        <div style={{ padding: "10px 14px 6px", borderBottom: "1px solid var(--border-subtle)" }}>
          <input className="atlas-input" placeholder="Search ticker…" style={{ width: "100%", fontSize: 12, height: 28 }} readOnly />
        </div>
        ...
        <div style={{ display: "flex", alignItems: "flex-end", gap: 16, flexWrap: "wrap" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <span className="atlas-badge" style={{ fontSize: 9 }}>{active.group.toUpperCase()}</span>
            </div>
          ...
          <div className="atlas-segmented">
            {RANGES.map((r) => (
              <button
                key={r}
                className={`atlas-segmented-item${r === range ? " is-active" : ""}`}
                onClick={() => setRange(r)}
              >
                {r}
              </button>
          ...
          <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm">Buy</button>
          <button className="atlas-btn-pill atlas-btn-pill-secondary atlas-btn-pill-sm">Sell</button>
        </div>

        {/* Chart card */}
        <div className="atlas-card">
          <div className="atlas-card-body" style={{ padding: "14px 14px 6px" }}>
            <MainChart data={active.series} color={activeColor} flashKey={updateCount % 1000} />
          </div>
          <div className="atlas-card-body" style={{ padding: "0 14px 14px", borderTop: "1px solid var(--border-subtle)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) minmax(0, 1fr)", gap: 12 }}>
          <div className="atlas-card">
            <div className="atlas-card-header">
              ...
              <span className="atlas-panel-title">Bids</span>
          ...
          <div className="atlas-card">
            <div className="atlas-card-header">
              ...
              <span className="atlas-panel-title">Asks</span>
              <span style={{ marginLeft: "auto", fontSize: 10, color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>
                top 5
              </span>
            </div>
      ...
      >
        ...
        <section style={{ padding: "14px 16px", borderBottom: "1px solid var(--border-subtle)" }}>
          <div className="atlas-eyebrow" style={{ marginBottom: 10 }}>Statistics</div>
        ...
        {/* 52-week range */}
        <section style={{ padding: "14px 16px", borderBottom: "1px solid var(--border-subtle)" }}>
          <div className="atlas-eyebrow" style={{ marginBottom: 10 }}>52-week range</div>
        ...
        {/* News */}
        <section style={{ padding: "14px 16px", borderBottom: "1px solid var(--border-subtle)" }}>
          <div className="atlas-eyebrow" style={{ marginBottom: 10 }}>Latest news</div>
        ...
        <section style={{ padding: "14px 16px" }}>
          <div className="atlas-eyebrow" style={{ marginBottom: 10 }}>Related</div>
