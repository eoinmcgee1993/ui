    ...
    <div className="atlas-card">
      <div className="atlas-card-header" style={{ display: "flex", justifyContent: "space-between" }}>
        <span style={{ display: "flex", alignItems: "center", gap: 6 }}>
          <span className="atlas-dot atlas-dot-info is-pulse" />
          <span className="atlas-panel-title">Live poll</span>
        </span>
        <span style={{ fontSize: 10, color: "var(--text-tertiary)", fontFamily: "var(--font-mono)" }}>{total} votes</span>
      </div>
      <div className="atlas-card-body" style={{ padding: 14 }}>
      ...
      <div className="atlas-card-body" style={{ padding: 10, borderTop: "1px solid var(--border-subtle)", display: "flex", gap: 6, alignItems: "center" }}>
        <button className="atlas-btn atlas-btn-primary atlas-btn-sm" style={{ flex: 1 }}>Vote now</button>
        <button className="atlas-btn atlas-btn-ghost atlas-btn-sm">Skip</button>
      </div>
    </div>
  );
}
  ...
  return (
    <div style={{ background: "var(--bg-base)", color: "var(--text-primary)", fontFamily: "var(--font-ui)", minHeight: "calc(100vh - 52px)" }}>
      ...
      <div style={{ background: "var(--status-error-muted)", borderBottom: "1px solid var(--status-error)", padding: "8px 24px", display: "flex", alignItems: "center", gap: 10 }}>
        <span className="atlas-badge atlas-badge-error">BREAKING</span>
      ...
      <header style={{ padding: "18px 32px 14px", borderBottom: "1px solid var(--border-default)", display: "flex", alignItems: "center", gap: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <div>
            <div style={{ fontSize: 18, fontWeight: 700, letterSpacing: "-0.02em" }}>Atlas Press</div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          <button className="atlas-btn atlas-btn-icon" aria-label="Search"><Icon paths="circle:11,11,8|M21 21l-4.3-4.3" /></button>
          <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm">Subscribe</button>
        </div>
      </header>
        ...
        <div>
          ...
          <article style={{ marginBottom: 28, paddingBottom: 28, borderBottom: "1px dashed var(--border-default)" }}>
            ...
            >
              <div style={{ position: "absolute", top: 14, left: 14, display: "flex", gap: 6 }}>
                <span className="atlas-badge atlas-badge-error">LIVE</span>
                <span className="atlas-badge">{lead.cat.toUpperCase()}</span>
              </div>
            </div>
            <h1 className="atlas-display" style={{ fontSize: 36, letterSpacing: "-0.025em", lineHeight: 1.1, fontWeight: 600, margin: "0 0 14px", maxWidth: 820 }}>
              {lead.headline}
            </h1>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 14, fontSize: 12, color: "var(--text-tertiary)" }}>
              <div className="atlas-avatar" style={{ width: 22, height: 22, fontSize: 10 }}>{lead.author.slice(0, 2).toUpperCase()}</div>
              ...
              <div style={{ flex: 1 }} />
              <button className="atlas-btn atlas-btn-icon" aria-label="Save"><Icon paths="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z" /></button>
              <button className="atlas-btn atlas-btn-icon" aria-label="Share"><Icon paths="circle:18,5,3|circle:6,12,3|circle:18,19,3" /></button>
            </div>
          </article>
          ...
          <section style={{ marginBottom: 28 }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              <div className="atlas-eyebrow">Top stories</div>
              <a href="#" className="atlas-link" style={{ fontSize: 12 }}>See all →</a>
            </div>
          ...
          <section>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
              <div className="atlas-eyebrow">More from today</div>
              <a href="#" className="atlas-link" style={{ fontSize: 12 }}>Catch up →</a>
            </div>
            {rest.slice(4).map((s) => (
        ...
        <aside style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          ...
          <div className="atlas-card">
            <div className="atlas-card-header">
              <span className="atlas-panel-title">Markets · 16:04 EST</span>
          ...
          {/* Newsletter */}
          <div className="atlas-card">
            <div className="atlas-card-body" style={{ padding: 18 }}>
              <div className="atlas-eyebrow" style={{ marginBottom: 10 }}>Newsletter</div>
              <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 6 }}>The Atlas Briefing</div>
              <div style={{ fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.5, marginBottom: 12 }}>
                Five stories, five minutes. Delivered 6 AM Eastern every weekday.
              </div>
              <input className="atlas-input" placeholder="you@domain.com" style={{ width: "100%", marginBottom: 8 }} />
              <button className="atlas-btn-pill atlas-btn-pill-primary atlas-btn-pill-sm" style={{ width: "100%" }}>Subscribe →</button>
          ...
          <div className="atlas-card">
            <div className="atlas-card-header">
              <span className="atlas-panel-title">Most read · today</span>
            </div>
            <div className="atlas-card-body" style={{ padding: 0 }}>
              {[
