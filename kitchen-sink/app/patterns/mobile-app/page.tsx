  ...
  return (
    <>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px 16px 10px", borderBottom: "1px solid var(--border-default)", flex: "none" }}>
        ...
        <button className="atlas-btn atlas-btn-icon" aria-label="New">
      ...
      <div style={{ flex: 1, overflowY: "auto" }}>
            ...
            {[
              ...
              <div key={p.title} style={{ padding: "12px 0", borderBottom: "1px solid var(--border-subtle)", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                  <span className={`atlas-dot atlas-dot-${p.dot}${p.dot === "warning" ? " is-pulse" : ""}`} />
        ...
        {tab === "inbox" && (
          <div style={{ padding: "16px 16px 24px" }}>
            {[
              { title: "Deploy succeeded — atlas-edge", time: "12:42", unread: true },
        ...
        {tab === "stats" && (
          <div style={{ padding: "16px 16px 24px", display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div className="atlas-filmstrip" style={{ height: 120, borderRadius: 6, border: "1px solid var(--border-default)", position: "relative" }}>
        ...
        {tab === "me" && (
          <div style={{ padding: "24px 16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
              <div className="atlas-avatar" style={{ width: 48, height: 48, fontSize: 16 }}>AD</div>
              <div>
...
export default function MobileAppPatternPage() {
  return (
    <PageBody
      inspector={
        <Inspector
          anatomy="Top bar (48px) · content (flex: 1, scrollable) · bottom tab bar (56px)."
          tokens={[".atlas-tabbar-bottom", ".atlas-btn-icon", ".atlas-dot.is-pulse", ".atlas-filmstrip"]}
          dos={["Use glass pills for floating controls over content", "Pulse dots for live/in-progress status only", "Tap tabs to switch — state is local, no routing"]}
          donts={["Don't hide the tab bar on scroll", "Don't nest more than one level of navigation"]}
        />
      }
    >
      <PageHeader
        eyebrow="Patterns"
        title="Mobile app"
        subtitle="A 4-screen native-style agent monitor. Glass-pill controls, bottom tab navigation, pulsing live-status dots, filmstrip placeholder for charts. Tap the tabs to switch screens — all state is local."
      />
      <Section title="Live preview" desc="Rendered inside .atlas-device-mobile at 75% scale so it fits alongside the docs content.">
