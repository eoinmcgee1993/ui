...
function renderGroups(
  ...
  if (query.trim()) {
    return (
      <>
        <div className="atlas-command-group-label">Results</div>
        {filtered.map((item, i) => (
          <button
            key={item.href}
            className="atlas-command-item"
            style={
              i === cursor
          ...
          >
            ...
            {item.klass && (
              <span className="atlas-command-item-shortcut">
  ...
  return (
    <>
      {NAV.map((group) => (
        <div key={group.label}>
          <div className="atlas-command-group-label">{group.label}</div>
